...
public class CodeGenerator {
    // 数据库连接配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/blog?serverTimezone=GMT%2B8";
    ...
    // 设置父包名
    private static final String PACKAGE_NAME = "com.zh";
    // 设置父包模块名
    private static final String MODULE_NAME = "blog";
    // 设置MVC下各个模块的包名
    private static final String ENTITY_NAME = "domain.entity";
    ...
    // 表名
    private static final String[] TABLE_LIST = {"menu", "role_menu"};
